 ...
 * @author vdh24
 */
public class TicTacJFrame extends javax.swing.JFrame {

    /**
     * Creates new form TicTacJFrame
     */
    public TicTacJFrame() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TicTacJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TicTacJFrame().setVisible(true);
            }
        });
    }
